...
if(isset($_SESSION["username"]) && isset($_SESSION["password"]) && $_SESSION["username"] && $_SESSION["password"]){
    ...
    $sqldis = "SELECT * FROM exbookshelf WHERE username='$usernameus' AND password='$passwordus'";
...
<br><br><br><br>
<p align="center" style="font-size: 50px; "><img src="images/Logo.jpg" style="width: 150px; height:150px;"></a>This is Kbone Exchange market-small bookshelf</p>
...
<?php
    ...
    <div>
    <td class="td"><a href="exchange_bookshelf_detail.php?deisbn=<?=$rowdis['ISBN']?>"><img src="exchange_cover/<?php echo $rowdis['imageex']; ?>" height="300px" width="200px"></a><br>
    <p style="">Title:<?php $isbn = $rowdis[5]; echo "$rowdis[3]";?></p>
    <p>Price:<?php echo "$rowdis[8]";?></p>
    <a href="exchange_shelftoexchange.php?deisbn=<?=$rowdis['ISBN']?>">Sell</a>
    </td>    
    </div>
    <!--show the book list-->
