...
if(isset($_SESSION["username"]) && isset($_SESSION["password"]) && $_SESSION["username"] && $_SESSION["password"]){
    ...
    $isbn = $_GET['deisbn'];
    $sqldetail ="SELECT * FROM exbooks WHERE ISBN='$isbn'";
...
<div class="container">
 <div class="row">
  ...
  <div class="col-sm-8" >
          ...
          <h2>Uploader: <?php echo "$rowdetail[1]";?></h2>
          ...
          <p style="font-size:75px; font-family: Impact,  Haettenschweiler, 'Arial Narrow Bold', sans-serif;"><a href="exmarket_action.php?deisbn=<?=$isbn?>&uploader=<?=$rowdetail[1]?>">Purchase</a></p>
 </div>         
 </div>
